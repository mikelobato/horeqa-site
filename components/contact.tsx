        ...
        <div className="grid gap-16 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-4 leading-relaxed text-muted-foreground">
              Whether you are planning a new technology rollout, need help with
              existing integrations, or want an independent assessment of your
              tech stack, we are here to help.
            </p>
